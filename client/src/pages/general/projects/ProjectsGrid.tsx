      ...
      <div className="max-w-7xl mx-auto bg-white dark:bg-gray-800 [data-theme='brand']:bg-gradient-to-br [data-theme='brand']:from-purple-50 [data-theme='brand']:to-pink-50 rounded-2xl shadow-lg dark:shadow-gray-900/20 [data-theme='brand']:shadow-purple-200/20 p-8 border border-gray-200 dark:border-gray-700 [data-theme='brand']:border-purple-200">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {sortedProjects.map((project: Project, index: number) => (
            <div key={`${project.id}-${index}`} className="bg-white dark:bg-gray-700 [data-theme='brand']:bg-gradient-to-br [data-theme='brand']:from-white [data-theme='brand']:to-purple-50 rounded-lg shadow-md border border-gray-100 dark:border-gray-600 [data-theme='brand']:border-purple-200 hover:shadow-lg dark:hover:shadow-gray-900/30 [data-theme='brand']:hover:shadow-purple-200/30 transition-shadow duration-200">
              <div className="p-6">
                <div className="flex items-start justify-between mb-4">
                  <h3 className="font-semibold text-gray-900 dark:text-white [data-theme='brand']:text-purple-900 text-lg leading-tight">{project.name}</h3>
                  <span className={`px-3 py-1 text-xs font-medium rounded-full ${getStatusColor(project.status)}`}>
                    {project.status.replace('_', ' ')}
                  </span>
                </div>

                <p className="text-gray-600 dark:text-gray-300 [data-theme='brand']:text-purple-800 text-sm mb-4 line-clamp-3">{project.description}</p>
                ...
                <div className="space-y-3 mb-4">
                  <div className="flex items-center justify-between text-sm">
                    ...
                    <span className="font-semibold text-white bg-indigo-600 dark:bg-indigo-600 [data-theme='brand']:bg-purple-600 px-2 py-1 rounded-full text-xs">{project.taskCount}</span>
                  </div>
                  <div className="flex items-center justify-between text-sm">
                    <div className="flex items-center text-gray-600 dark:text-gray-400 [data-theme='brand']:text-purple-800">
                    ...
                    <span className="font-semibold text-white bg-green-600 dark:bg-green-600 [data-theme='brand']:bg-pink-600 px-2 py-1 rounded-full text-xs">{project.memberCount}</span>
                  </div>
                  <div className="flex items-center justify-between text-sm">
                    <div className="flex items-center text-gray-600 dark:text-gray-400 [data-theme='brand']:text-purple-800">
                    ...
                    <span className="font-medium text-gray-900 dark:text-white [data-theme='brand']:text-purple-900 text-xs">{project.owner.firstName} {project.owner.lastName}</span>
                  </div>
                  <div className="flex items-center justify-between text-sm">
                    <div className="flex items-center text-gray-600 dark:text-gray-400 [data-theme='brand']:text-purple-800">
                    ...
                    <span className="font-medium text-gray-900 dark:text-white [data-theme='brand']:text-purple-900 text-xs">{formatCreatedDate(project.createdAt)}</span>
                  </div>
                </div>

                <div className="pt-4 border-t border-gray-100 dark:border-gray-600 [data-theme='brand']:border-purple-200">
                  <Link
