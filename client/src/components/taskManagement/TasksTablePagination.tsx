...
import { PaginationInfo } from '../../types/taskManagement';
import { TASKS_PAGINATION_OPTIONS } from '../../constants/taskManagement';
...
/**
 * Tasks Table Pagination Component
 * Displays pagination controls with responsive design
 */
const TasksTablePagination: React.FC<TasksTablePaginationProps> = ({
  paginationInfo,
  currentPageSize,
  loading,
  onPageChange,
