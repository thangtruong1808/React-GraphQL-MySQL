...
import { TASK_STATUS_OPTIONS } from '../../constants/taskManagement';
...
/**
 * Task Status Field Component
 * Displays status select field with options
 */
const TaskStatusField: React.FC<TaskStatusFieldProps> = ({ value, onChange, disabled }) => {
  ...
  return (
    <div>
      <label htmlFor="status" className="block text-sm font-semibold mb-2" style={{ color: 'var(--text-primary)' }}>
