 ...
 * Description: Displays branded company information with logo, description, and social media links
 * Date: 2024-12-19
 * Author: thangtruong
 */
    ...
    <div>
      ...
      <div className="flex space-x-3">
        ...
        <button
          ...
          className="transition-all duration-300 rounded-full p-2.5 hover:scale-110 focus:outline-none focus:ring-2 focus:ring-offset-2"
          style={{
            color: 'var(--footer-social-github)',
            backgroundColor: 'var(--footer-social-github-bg)',
            focusRingColor: 'var(--footer-social-github-hover)'
          }}
          onMouseEnter={(e) => {
        ...
        <button
          ...
          style={{
            ...
            focusRingColor: 'var(--footer-social-linkedin-hover)'
          }}
          onMouseEnter={(e) => {
        ...
        <button
          ...
          style={{
            ...
            focusRingColor: 'var(--footer-social-facebook-hover)'
          }}
          onMouseEnter={(e) => {
