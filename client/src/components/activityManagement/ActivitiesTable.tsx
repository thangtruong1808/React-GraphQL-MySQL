          ...
          <table className="min-w-full theme-table-divide table-fixed">
            <thead className="theme-table-header-bg">
              <tr>
                ...
                <th className={`px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider ${ACTIVITY_TABLE_COLUMNS.USER.width}`}>
                  User
                </th>
                <th className={`px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider ${ACTIVITY_TABLE_COLUMNS.TYPE.width}`}>
                  Type
                </th>
                <th className={`px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider ${ACTIVITY_TABLE_COLUMNS.ACTION.width}`}>
                  Action
                </th>
                <th className={`px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider ${ACTIVITY_TABLE_COLUMNS.TARGET_USER.width}`}>
                  Target User
                </th>
                <th className={`px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider ${ACTIVITY_TABLE_COLUMNS.PROJECT.width}`}>
                  Project
                </th>
                <th className={`px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider ${ACTIVITY_TABLE_COLUMNS.TASK.width}`}>
                  Task
                </th>
                <th className={`px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider ${ACTIVITY_TABLE_COLUMNS.CREATED.width}`}>
                  Created
                </th>
                <th className={`px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider ${ACTIVITY_TABLE_COLUMNS.UPDATED.width}`}>
                  Updated
                </th>
                <th className={`px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider ${ACTIVITY_TABLE_COLUMNS.ACTIONS.width}`}>
                  Actions
                </th>
              </tr>
            </thead>
        ...
        <table className="min-w-full theme-table-divide table-fixed">
          <thead className="theme-table-header-bg">
            <tr>
              ...
              <th
                className={`hidden lg:table-cell px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider cursor-pointer hover:bg-gray-100 transition-colors ${ACTIVITY_TABLE_COLUMNS.ID.width}`}
              ...
              <th
                className={`px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider cursor-pointer hover:bg-gray-100 transition-colors duration-200 ${ACTIVITY_TABLE_COLUMNS.USER.width}`}
              ...
              <th
                className={`px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider cursor-pointer hover:bg-gray-100 transition-colors duration-200 ${ACTIVITY_TABLE_COLUMNS.TYPE.width}`}
              ...
              <th className={`hidden sm:table-cell px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider ${ACTIVITY_TABLE_COLUMNS.ACTION.width}`}>
                Action
              </th>
              {/* Target User Column - Hidden on mobile and tablet */}
              <th
                className={`hidden lg:table-cell px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider cursor-pointer hover:bg-gray-100 transition-colors duration-200 ${ACTIVITY_TABLE_COLUMNS.TARGET_USER.width}`}
              ...
              <th
                className={`hidden sm:table-cell px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider cursor-pointer hover:bg-gray-100 transition-colors duration-200 ${ACTIVITY_TABLE_COLUMNS.PROJECT.width}`}
              ...
              <th
                className={`hidden sm:table-cell px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider cursor-pointer hover:bg-gray-100 transition-colors duration-200 ${ACTIVITY_TABLE_COLUMNS.TASK.width}`}
              ...
              <th
                className={`hidden xs:table-cell px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider cursor-pointer hover:bg-gray-100 transition-colors duration-200 ${ACTIVITY_TABLE_COLUMNS.CREATED.width}`}
              ...
              <th
                className={`hidden lg:table-cell px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider cursor-pointer hover:bg-gray-100 transition-colors duration-200 ${ACTIVITY_TABLE_COLUMNS.UPDATED.width}`}
            ...
            {activities.length === 0 ? (
              <tr>
                <td colSpan={10} className="px-6 py-12 text-center text-gray-500">
                  <div className="flex flex-col items-center">
                    ...
                    <p className="text-lg font-medium text-gray-900 mb-1">No activities found</p>
                    <p className="text-gray-500">Try adjusting your search criteria or create a new activity.</p>
                  </div>
                </td>
              </tr>
            ) : (
              activities.map((activity) => (
                <tr key={activity.id} className="theme-table-row-hover-bg transition-colors duration-200">
                  ...
                  {/* Action Column - Hidden on mobile */}
                  <td className={`hidden sm:table-cell px-4 py-4 text-sm text-gray-900 text-left ${ACTIVITY_TABLE_COLUMNS.ACTION.width}`}>
                  ...
                  {/* Target User Column - Hidden on mobile and tablet */}
                  <td className={`hidden lg:table-cell px-4 py-4 whitespace-nowrap text-sm text-gray-900 text-left ${ACTIVITY_TABLE_COLUMNS.TARGET_USER.width}`}>
                    {activity.targetUser ? (
                      <div className="flex flex-col">
                        <p className="font-medium">
                  ...
                  {/* Project Column - Hidden on mobile */}
                  <td className={`hidden sm:table-cell px-4 py-4 whitespace-nowrap text-sm text-gray-900 text-left ${ACTIVITY_TABLE_COLUMNS.PROJECT.width}`}>
                    {activity.project ? (
                  ...
                  {/* Task Column - Hidden on mobile */}
                  <td className={`hidden sm:table-cell px-4 py-4 whitespace-nowrap text-sm text-gray-900 text-left ${ACTIVITY_TABLE_COLUMNS.TASK.width}`}>
                    {activity.task ? (
                  ...
                  {/* Created Column - Hidden on mobile */}
                  <td className={`hidden xs:table-cell px-4 py-4 whitespace-nowrap text-sm text-gray-500 text-left ${ACTIVITY_TABLE_COLUMNS.CREATED.width}`}>
                    {formatDate(activity.createdAt)}
                  </td>

                  {/* Updated Column - Hidden on mobile and tablet */}
                  <td className={`hidden lg:table-cell px-4 py-4 whitespace-nowrap text-sm text-gray-500 text-left ${ACTIVITY_TABLE_COLUMNS.UPDATED.width}`}>
