...
interface CreateUserModalActionsProps {
  onClose: () => void;
  loading: boolean;
}

/**
 * Create User Modal Actions Component
 * Displays cancel and create user buttons
 */
const CreateUserModalActions: React.FC<CreateUserModalActionsProps> = ({ onClose, loading }) => {
  // Handle cancel click
  const handleCancel = () => {
    onClose();
  };
...
export default CreateUserModalActions;
