...
/**
 * User Last Name Field Component
 * Displays last name input field with validation feedback
 */
const UserLastNameField: React.FC<UserLastNameFieldProps> = ({ value, error, touched, onChange, onBlur, disabled }) => {
  // Handle input change
...
export default UserLastNameField;
