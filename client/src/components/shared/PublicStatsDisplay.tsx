...
/**
 * Description: Outputs headline statistics for the public dashboard hero using themed surfaces.
 * Data created: Consumes provided aggregate stats without introducing local component state.
 * Author: thangtruong
 */
...
const PublicStatsDisplay: React.FC<PublicStatsDisplayProps> = ({ stats }) => {
  return (
    <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-4xl mx-auto">
      {/* Total Projects Card */}
      <div
        className="rounded-xl p-6 shadow-md border theme-border hover:shadow-xl transition-shadow duration-500"
        style={{
