    ...
    >
      <div className="space-y-4">
        ...
        <div>
          ...
          <h3 className="text-lg font-semibold text-gray-900 group-hover:text-purple-700 transition-colors duration-200">{task.title}</h3>
        </div>
        ...
        <div>
          ...
          <p className="text-gray-700 leading-relaxed group-hover:text-purple-600 transition-colors duration-200">{task.description}</p>
        </div>
            ...
            {task.project && (
              <div>
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-sm font-medium text-gray-700 group-hover:text-purple-600 transition-colors duration-200">{task.project.name}</span>
                </div>
              </div>
            )}
