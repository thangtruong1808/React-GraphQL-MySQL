...
const RoleFilters: React.FC<RoleFiltersProps> = ({
  ...
  const availableRoles = [
    ...
    { key: 'DEVOPS_ENGINEER', label: 'DevOps Engineer', icon: 'M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10', color: 'text-orange-500' },
    { key: 'QA_ENGINEER', label: 'QA Engineer', icon: 'M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z', color: 'text-indigo-500' },
    { key: 'QC_ENGINEER', label: 'QC Engineer', icon: 'M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z', color: 'text-indigo-500' },
