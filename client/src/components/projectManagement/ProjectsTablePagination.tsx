...
import { PaginationInfo } from '../../types/projectManagement';
...
/**
 * Projects Table Pagination Component
 * Displays pagination controls with responsive design
 */
const ProjectsTablePagination: React.FC<ProjectsTablePaginationProps> = ({
  paginationInfo,
  currentPageSize,
  loading,
  onPageChange,
