...
interface EditProjectModalActionsProps {
  loading: boolean;
  onCancel: () => void;
}

/**
 * Edit Project Modal Actions Component
 * Displays Cancel and Update buttons
 */
const EditProjectModalActions: React.FC<EditProjectModalActionsProps> = ({ loading, onCancel }) => {
  // Handle cancel click
  const handleCancel = () => {
    onCancel();
  };
...
export default EditProjectModalActions;
