...
interface EditProjectModalHeaderProps {
  onClose: () => void;
  loading: boolean;
}

/**
 * Edit Project Modal Header Component
 * Displays header with title and close button
 */
const EditProjectModalHeader: React.FC<EditProjectModalHeaderProps> = ({ onClose, loading }) => {
  // Handle close click
  const handleClose = () => {
    onClose();
  };
...
export default EditProjectModalHeader;
